...
export const projectFields: Field[] = [
  ...
  { type: 'url', name: 'websiteUrl', label: 'Link do projeto online', help: 'Ex.: https://frisospneus.pt — aparece como botão clicável na página do case. Deixe vazio para não mostrar.' },
  ...
  { type: 'boolean', name: 'showStack', label: 'Mostrar tecnologias no site', help: 'Desligado por omissão: a maioria dos clientes não precisa de ver a stack técnica. Ligue só se fizer sentido para este case.' },
